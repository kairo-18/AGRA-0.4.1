    ...
    <div class="innerDiv xl:flex bg-gray-50 h-full w-full rounded-lg xl overflow-auto">
        ...
        <div class="left-panel flex flex-col  bg-trnsparent h-screen w-full p-10">
            ...
            <div class ="lbl-course p-5 bg-transparent rounded-md">
                ...
                <h3 class="text-xl text-blue-600">Tasks due on this date:</h3>
            </div>
            ...
            <div class="nav-section flex content-center bg-transparent h-16 w-full pl-2">
                <div class="text-xs font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700 w-full">
                    <ul class="flex flex-wrap -mb-px">
                        <li class="me-2">
                            <a href="/" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-blue-500 dark:hover:text-gray-300 text-xs font-semibold">Back to home</a>
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            <div class="h-1/5">
                                <div class="w-full h-48 p-3 rounded-xl bg-cover bg-center bg-gradient shadow-md flex justify-between">
                                    ...
                                    <div class="badge mb-2 ml-2">
                                        ...
                                        @else
                                            <span class="bg-gray-300 text-gray-600 text-xs font-medium px-2.5 py-0.5 rounded">Deadline Now!</span> <!-- Fallback if null -->
                                        @endif
                                    </div>
                                </div>
                                <div class="w-full p-3 bg-white rounded-xl">
                                    <h1 class="font-bold text-md text-blue-800">{{$task->TaskName}}</h1>
                                    <span class="text-gray-500 text-xs font-bold">Deadline: {{ $deadline->format('g:i A') }}</span>
