...
<div id="startPanel" class="w-full h-full fixed inset-0 backdrop-blur-md">
    ...
    <div class="startPaneldiv2 absolute left-0 top-0 transform -translate-x-0 -translate-y-0 flex flex-col items-center justify-center p-4 w-[40rem] max-w-md h-max m-5">
