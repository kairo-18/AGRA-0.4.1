            ...
            <section class="dark:bg-gray-900 w-full h-auto">
                <div class="py-2 px-2 sm:py-4 sm:px-3 mx-auto max-w-screen-md lg:py-6">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 sm:p-5 md:p-6 mb-4">
                        ...
                        <h1 class="text-gray-900 dark:text-white text-lg sm:text-xl font-extrabold mb-2">How to quickly deploy a static website</h1>
                        <p class="text-sm sm:text-base font-normal text-gray-500 dark:text-gray-400 mb-3 sm:mb-4">Static websites are now used to bootstrap lots of websites and are becoming the basis for a variety of tools that even influence both web designers and developers.</p>
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 sm:p-5">
                            ...
                            <h2 class="text-gray-900 dark:text-white text-lg font-extrabold mb-2">Start with Flowbite Design System</h2>
                            <p class="text-sm font-normal text-gray-500 dark:text-gray-400 mb-3">Static websites are now used to bootstrap lots of websites and are becoming the basis for a variety of tools.</p>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 sm:p-5">
                            ...
                            <h2 class="text-gray-900 dark:text-white text-lg font-extrabold mb-2">Best React libraries around the web</h2>
                            <p class="text-sm font-normal text-gray-500 dark:text-gray-400 mb-3">Explore the top libraries for building applications with React.</p>
                            <a href="#" class="text-blue-600 dark:text-blue-500 hover:underline font-medium text-base inline-flex items-center">Read more
                                <svg class="w-3 h-3 ml-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                                </svg>
