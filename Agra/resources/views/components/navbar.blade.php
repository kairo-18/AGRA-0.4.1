<style>
    @keyframes slideFromMenu {
        0% {
            transform: translateX(-150%) rotate(0deg); /* Start behind the menu */
        ...
        100% {
            transform: translateX(0) rotate(360deg); /* End in the default position with a full rotation */
        }
    }

    .slide-rotate-img {
        animation: slideFromMenu 2s ease-out forwards;
    }
</style>
<nav class="bg-gradient-to-r from-blue-800 to-blue-600 border-gray-200 dark:bg-gray-900">
    <div class="w-full flex flex-wrap items-center justify-between p-5 pl-5 pr-5">

        <!---------Start Menu btn-------------->
        <div class="btn-menu flex flex-row justify-start w-1/3">
            <button class="text-black bg-white hover:bg-blue-200 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-xs px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 transition ease-in-out delay-150 bg-blue-300 hover:-translate-y-1 hover:scale-110 hover:bg-blue-600 duration-300" type="button" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation" aria-controls="drawer-navigation">
                <svg class="menu-icon-animation flex-shrink-0 w-3 h-3 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 17 14">
        ...
        <div id="drawer-navigation" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-hidden transition-transform -translate-x-full bg-blue-800 w-64 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
            <h5 id="drawer-navigation-label" class="text-2xl font-semibold text-white dark:text-gray-400"></h5>
        ...
        <div class="py-4 overflow-y-hidden">
            <ul class="space-y-1 font-medium">
                ...
                <li>
                    <a href="/" class="flex items-center p-2 mb-5 text-white hover:text-blue-800 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span class="ms-3 text-md">Home</span>
                    </a>
                </li>
                <li>
                    <a href="/courses" class="flex items-center p-2 mb-5 text-white hover:text-blue-800 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap text-md">Courses</span>
                ...
                <li>
                    <a href="/recommendation" class="flex items-center p-2 mb-5 text-white hover:text-blue-800 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap text-md">Recommendation</span>
                    </a>
                </li>
                <li>
                    <a href="/aboutUs" class="flex items-center p-2 mb-5 text-white hover:text-blue-800 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-7 h-7 text-white transition duration-75 dark:text-gray-400 group-hover:text-blue-800 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            <path fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm11-4a1 1 0 1 0-2 0v5a1 1 0 1 0 2 0V8Zm-1 7a1 1 0 1 0 0 2h.01a1 1 0 1 0 0-2H12Z" clip-rule="evenodd"/>
                        </svg>
                        <span class="flex-1 ms-3 whitespace-nowrap text-md">About Us</span>
                    </a>
                </li>

                <li>
                    <a href="/multiplayer" class="flex items-center p-2 mb-5 text-white hover:text-blue-800 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap text-md">Multiplayer</span>
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="pb-10">
            <form method="POST" id="logout" action="{{ route('logout') }}">
                <a href="javascript:document.getElementById('logout').submit();" class="flex items-center p-2 text-white hover:text-blue-800 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap text-md font-semibold">Log Out</span>
                </a>
                {{ csrf_field() }}
            </form>
        </div>
        ...
        <div class ="btn-logo flex flex-row justify-center w-1/3">
            <a href="/agra" class="flex items-center space-x-3 rtl:space-x-reverse transition ease-in-out delay-150 bg-transparent hover:-translate-y-1 hover:scale-110 hover:bg-blue-600 duration-300 rounded-lg w-30 h-full">
                <img src="/AGRA-Logo.png" class="slide-rotate-img h-6" alt="Flowbite Logo" />
                <span class="self-center text-lg font-semibold whitespace-nowrap text-white">AGRA</span>
            </a>
        </div>
        <!-----------------End Logo--------------------->
        ...
        <div class ="btn-profile flex flex-row gap-10 justify-end w-1/3">
            ...
            <div class="relative ml-4">
                ...
                <div id="notifications-dropdown" class="absolute right-0 z-50 hidden w-[500px] h-[250px] overflow-auto border-double border-2 border-sky-500 mt-5 bg-gray-100 shadow-2xl divide-y divide-gray-100 rounded-lg dark:bg-gray-700 dark:divide-gray-600">
                    <div class="pb-2">
            ...
            <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="text-blue-900 bg-white hover:bg-blue-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                <img src="/profileIcon.png" class="w-5 mr-4">
