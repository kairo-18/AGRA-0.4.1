        ...
        <div class="left-panel flex flex-col  bg-trnsparent h-screen w-full p-10">
            ...
            <div class = "learM-section flex flex-col bg-gray-200 h-full w-full rounded-lg overflow-auto items-center p-10 shadow-inner gap-y-4">
                ...
                <div class="w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    @if (array_key_exists($task->TaskType, $taskRoutes))
                        <a href="/tasks/{{ $taskRoutes[$task->TaskType] }}/{{ $task->id }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Play
